			...
			<div class="row justify-content-center align-items-center " style="margin-top: 15px">
				...
				<div class="col-sm-6 justify-content-center align-items-center"><!--coluna de funcionario-->					
					...
					<div class="area_mensagem"><!--area de botoes funcionario -->
						...
						<a class="btn btn-primary largura" href="cadastro_de_fun.html">Cadastro de Funcionario</a>
				...
				<div class="col-sm-6 justify-content-center align-items-center"><!--coluna de requerimento-->					
					...
					<div class="area_mensagem"><!--area de botoes requerimento-->
						...
						<a class="btn btn-success largura" href="cadastro_de_req.html">Cadastro de Requerimento</a>
						<a class="btn btn-success largura" href="relatorio_de_req.html">Relatório de  Requerimento</a>
